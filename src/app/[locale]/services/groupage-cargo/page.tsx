  ...
  return (
    <>
      <PageHero
        ...
        text="Збірні вантажі доступні для клієнтів із регулярними поставками, сумісними температурними режимами та погодженим графіком консолідації."
        title="Збірні вантажі"
      />
